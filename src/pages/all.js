...
function all() {
  function deleteCharacter(id) {
    axios
      .delete("https://starwars-9dab.onrender.com/api/delete/" + id)
      .then((response) => {
  ...
  function updateCharacter(personaje) {
    axios
      .put("https://starwars-9dab.onrender.com/api/update", personaje)
      .then((response) => {
        console.log(response);
        getAllCharacters();
      });
  ...
  function getAllCharacters() {
    axios
      .get("https://starwars-9dab.onrender.com/api/characters/")
      .then((response) => {
        console.log(response);
